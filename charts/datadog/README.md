...
| datadog.sbom.enabled | bool | `false` | Enable SBOM (Software Bill Of Materials) collection |
| datadog.sbom.host.enabled | bool | `false` | Enable SBOM collection for host filesystem |
